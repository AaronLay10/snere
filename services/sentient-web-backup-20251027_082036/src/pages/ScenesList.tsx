...
export default function RoomScenesPage() {
  ...
  const loadScenes = async () => {
    try {
      setLoading(true);
      const data = await scenes.getAll({ roomId });
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {['admin', 'editor'].includes(user?.role || '') && (
            <button
              onClick={() => navigate(`/dashboard/rooms/${roomId}/scenes/new`)}
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                      ...
                      {scene.estimated_duration_seconds && (
                        <div className="flex items-center gap-2 text-gray-500">
                          ...
                          <span>{Math.floor(scene.estimated_duration_seconds / 60)}m {scene.estimated_duration_seconds % 60}s</span>
                        </div>
                      )}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {['admin', 'editor'].includes(user?.role || '') && (
                      <>
                        <button
                          onClick={() => navigate(`/dashboard/rooms/${roomId}/scenes/${scene.id}/edit`)}
