...
const { requireRole, requireCapability } = require('../middleware/rbac');
const { queryAuditLogs, getAuditStats } = require('../middleware/audit');
 ...
 */
router.get('/resource/:resourceType/:resourceId', authenticate, requireCapability('read'), async (req, res) => {
  try {
