...
#define DEVICE_ID "Vault"
#define DEVICE_FRIENDLY_NAME "Vault Puzzle"
#define ROOM_ID "Clockwork"
#define PUZZLE_ID "Vault"
  ...
  if (rfid.readTag(tag, sizeof(tag)))
  {
    ...
    for (int i = 0; i < 36; i++)
    {
      if (strcmp(tag, tagList[i]) == 0)
      {
        ...
        found = true;
        char vaultNum[4];
        snprintf(vaultNum, sizeof(vaultNum), "%d", i + 1);
        mythra.publishText("Telemetry", "vault_number", vaultNum);
        break;
      }
    }
