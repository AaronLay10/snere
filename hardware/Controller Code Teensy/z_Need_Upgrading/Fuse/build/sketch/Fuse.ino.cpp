#include <Arduino.h>
#line 1 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
#include <ParagonMQTT.h>

const char *deviceID = "Fuse"; // CHANGE deviceID TO THE NAME YOU WANT THIS TEENSY TO BE IDENTIFIED
...
#line 67 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void setup();
#line 146 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void loop();
#line 183 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void handleRFID(HardwareSerial &rfid, char *publishBuffer, int tirPin, bool *tagPresent);
#line 200 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void processRFID(char incomingChar, char *publishBuffer);
#line 224 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void cleanTag(char *tag);
#line 238 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void fuse(const char *value);
#line 245 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void knifeswitch(const char *value);
#line 252 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void resistorCalc();
#line 276 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
void metalDoor(const char *value);
#line 283 "/Users/aaron/Documents/ParagonEscape/Clockwork/Puzzles/Fuse/Fuse.ino"
...
void setup()
{
  ...
  registerAction("fuse", fuse);
  registerAction("knifeswitch", knifeswitch);
  registerAction("metalDoor", metalDoor); // Placeholder for future action
  registerAction("dropPanel", dropPanel);
}
...
void loop()
{
  ...
  // Build the publish string (without labels, just the tag data)
  ...
  // Ensure the final output is printed on one line
  Serial.println(publishDetail); // Use Serial.print() to avoid extra new lines
...
void resistorCalc()
{
  ...
  resistorValues[0] = (rA > maxResistor) ? 0 : rA;
  resistorValues[1] = (rB > maxResistor) ? 0 : rB;
  resistorValues[2] = (rC > maxResistor) ? 0 : rC;
}
