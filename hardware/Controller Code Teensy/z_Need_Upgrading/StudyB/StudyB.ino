...
#define DEVICE_ID "StudyB"
#define DEVICE_FRIENDLY_NAME "Study B Controller"
#define ROOM_ID "Clockwork"
#define PUZZLE_ID "System"
...
void setup()
{
    ...
    mythra.setCommandCallback([](const char *command, const JsonDocument &payload, void *context) {
        if (payload.is<const char*>()) {
            ...
            } else if (strcmp(command, "fanControl") == 0) {
                fanControlHandler(value);
            } else if (strcmp(command, "wallGearsControl") == 0) {
                wallGearsControlHandler(value);
            } else if (strcmp(command, "tvPower") == 0) {
                tvPowerHandler(value);
            } else if (strcmp(command, "makservoPower") == 0) {
                makservoPowerHandler(value);
            } else if (strcmp(command, "fogPower") == 0) {
                fogPowerHandler(value);
            } else if (strcmp(command, "fogTrigger") == 0) {
                fogTriggerHandler(value);
            } else if (strcmp(command, "fogControl") == 0) {
                fogControlHandler(value);
            } else if (strcmp(command, "reset") == 0) {
                resetHandler(value);
            } else if (strcmp(command, "studyFanLight") == 0) {
                studyFanLightHandler(value);
            } else if (strcmp(command, "blackLights") == 0 || strcmp(command, "blacklights") == 0) {
                blackLightsHandler(value);
            }
        }
    });

    Serial.println("StudyB System Ready - Custom Stepper Control Initialized (MythraOS_MQTT)");
}
...
void activateHandler(const char *value)
{
    ...
    sprintf(telemetryMsg, "system_%s", systemActive ? "activated" : "deactivated");
    mythra.publishText("Telemetry", "data", telemetryMsg);
}
...
void studyFanLightHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", lightState ? "fan_light_on" : "fan_light_off");
}
...
void blackLightsHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", shouldTurnOn ? "blacklights_on" : "blacklights_off");
}
...
void fanControlHandler(const char *value)
{
    ...
    case 0: // Stop
        ...
        mythra.publishText("Telemetry", "data", "fan_stopped");
        break;
    ...
    case 1: // Slow speed - continuous rotation
        ...
        mythra.publishText("Telemetry", "data", "fan_slow");
        break;
    ...
    case 2: // Fast speed - continuous rotation
        ...
        mythra.publishText("Telemetry", "data", "fan_fast");
        break;
...
void wallGearsControlHandler(const char *value)
{
    ...
    case 0: // Stop
        ...
        mythra.publishText("Telemetry", "data", "wallgears_stopped");
        break;
    ...
    case 1: // Slow speed - continuous rotation
        ...
        mythra.publishText("Telemetry", "data", "wallgears_slow");
        break;
    ...
    case 2: // Fast speed - continuous rotation
        ...
        mythra.publishText("Telemetry", "data", "wallgears_fast");
        break;
...
void tvPowerHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", powerState ? "tv_power_on" : "tv_power_off");
}
...
void makservoPowerHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", powerState ? "makservo_power_on" : "makservo_power_off");
}
...
void fogPowerHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", powerState ? "fog_power_on" : "fog_power_off");
}
...
void fogTriggerHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", triggerState ? "fog_trigger_on" : "fog_trigger_off");
}
...
void resetHandler(const char *value)
{
    ...
    mythra.publishText("Telemetry", "data", "system_reset");
}
