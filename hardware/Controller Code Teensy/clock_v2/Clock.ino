...
#define DEVICE_ID "Clock"
#define DEVICE_FRIENDLY_NAME "Clock Puzzle"
#define ROOM_ID "Clockwork"
#define PUZZLE_ID "Clock"
...
void handleCrankStage()
{
        ...
        encoderTopBCount != lastEncoderTopBCount)
    {
        ...
        if (ratioCorrect)
        {
            ...
            mythra.publishText("Events", "event", "crank_complete");
        }
    }
}
    ...
    if (timeChanged)
    {
        ...
        else if (currentPressCount >= maxPresses)
        {
            ...
            if (abs(currentTime - targetTime) < 0.1) // Close enough to 6.5 hours
            {
                ...
                moveClockToTime(currentTime);
                mythra.publishText("Events", "event", "pilaster_complete");
            }
            else
            {
                ...
                mythra.publishText("Events", "event", "pilaster_failed");
                currentTime = 0.0;
                currentPressCount = 0;
                moveClockToTime(currentTime);
            }
