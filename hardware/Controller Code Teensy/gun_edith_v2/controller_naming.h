...
// Gun Edith Controller v2 — Canonical naming
...
namespace naming
{
    ...
    constexpr const char *CONTROLLER_ID = firmware::UNIQUE_ID; // "gun_edith"
    constexpr const char *CONTROLLER_FRIENDLY_NAME = "Gun Edith Controller";
