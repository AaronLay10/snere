...
// Lighting Main Controller v2 — Canonical naming
...
namespace naming
{
    ...
    constexpr const char *CONTROLLER_ID = firmware::UNIQUE_ID; // "lighting_main"
    constexpr const char *CONTROLLER_FRIENDLY_NAME = "Lighting Main Controller";
