...
namespace firmware
{
  ...
  constexpr const char *UNIQUE_ID = "maks_servo";
  constexpr const char *DESCRIPTION = "STATELESS EXECUTOR - PWM servo control (open/close). Sentient makes all decisions.";
}
