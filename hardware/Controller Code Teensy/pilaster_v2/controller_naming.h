...
// Pilaster Puzzle Controller v2 — Canonical naming
...
namespace naming
{
    ...
    constexpr const char *CONTROLLER_ID = firmware::UNIQUE_ID; // "pilaster"
    constexpr const char *CONTROLLER_FRIENDLY_NAME = "Pilaster Puzzle Controller";
